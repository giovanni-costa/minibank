...
export class AdminService {
  ...
  async createCustomer(data: CreateAdminDto) {
    ...
    if(data.id) { throw new HttpException('IDs are autogenerated', HttpStatus.BAD_REQUEST) }
    ...
    if(cpfExists) { throw new HttpException('CPF already exists', HttpStatus.CONFLICT)}
